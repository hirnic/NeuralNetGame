...
class TrialData:
    def __init__(self, round_seed, moves):
        self.number = round_seed  # The string of digits
        self.moves = moves  # The string of digits
        self.score = 0  # Int
        self.prices = []  # List of ints

    def performance(self):
        pass

    def toArray(self):
        return [self.number, self.moves]
...
def create_collectible():
    ...
    n += 1
    move_player(n - 5)
    trial_data.prices.append(collectibles[-1].price)
...
def start_game(level):
    ...
    trial_data.number = number
    trial_data.moves = player_moves
